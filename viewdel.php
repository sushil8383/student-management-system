...
<body>
	...
	<tr>
		...
		<td align="center">
			<a style="color: red" href="delete.php?name=<?php echo $row["name"]; ?>"><img src="logo.jpg" width="30px" /></a></td>
		<td align="center">
			<a style="color: red" href="update.php?name=<?php echo $row["name"]; ?>"><img src="logo.jpg" width="30px" /></a></td>
	</tr>
	<?php
	}
	?>
